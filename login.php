	...
	if(isset($_POST['submit'])){
		...
		if(!empty($users_email) && !empty($users_password)){
			...
			if($query->num_rows > 0){
				...
				header('location:property_list.html');
			}else{
...
button {   
 ...
 .container {   
    ...
    <img src="img/fg2.gif" style='width:200px ;height: 150px;'>
</div>
<div class='login_div'>

    <header class='login_header'>
         <center><h1 class='h1_title'><a href="Contact_Us.php" class="text-decoration-none"> Contact Us  </h1></a></center>
