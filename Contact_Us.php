...
<div class="header">
<img src="img/favicon.png" style='width:45px ;height: 45px;'>
...
<div class="row">
  ...
  <center>
    <div class="card">
      <img src="img/user.png" alt="Bhavin" style="width:30%">
      <div class="container">
        <h2 style='color:white; font-size:30px' >Bimal  Patil</h2>
        ...
        <p style='color:green; font-size:14px'>abc@example.com</p>
